...
### Phase 3 — 體驗打磨 (約 2-3 天) ✅ 多數完成 (Sentry 移到後續)
...
- ⏸ `#27` i18n (純機械工作，延後)
- ✅ `#34` K 線型態辨識 (12+ 種型態)
- ⏸ `#35` 圖表畫線工具 (UI 工程量大，延後)
- ✅ `#36` 自訂指標參數
- ✅ `#28` Android 背景排程實作 (workmanager)
- ⏸ `#25` 崩潰回報 Sentry (DSN 待設定)
...
| 2026-05-11 | #09 #10 | ✅ K 線多週期 (日/週/月) + 5 種區間切換 |
| 2026-05-11 | #13 | ✅ 加權指數對比 (IR0001) 標準化疊圖 |
| 2026-05-11 | #11 | ✅ 基本面快照 (PE/PB/殖利率，TWSE BWIBBU_d) |
| 2026-05-11 | #08 | ✅ 市場熱度頁 (漲跌幅/成交量值排行 × 上市/上櫃) |
| 2026-05-11 | #22 | ✅ 自製 Shimmer widget (不引外部套件) |
| 2026-05-11 | #16 | ✅ EmptyWatchlistView (illustration + 熱門股 quick add) |
| 2026-05-11 | #17 | ✅ 3 頁 onboarding (歡迎 / Token / 自選) |
| 2026-05-11 | #32 | ✅ 隱私政策 + 使用條款 (內嵌 Markdown 渲染) |
...
| 2026-05-11 | #04 | ✅ 逐筆成交清單 (大單高亮 + 主動買賣方向標籤) |
| 2026-05-11 | #05 | ✅ 分價量表 (水平柱狀 + 內外盤拆分 + 主力價位提示) |
| 2026-05-11 | #07 | ✅ 減資 / ETF 分割預告 + 歷史紀錄 |
| 2026-05-11 | #36 | ✅ 自訂指標參數頁 (MA/RSI/KD/MACD/Bollinger/ATR) |
| 2026-05-11 | #34 | ✅ K 線型態辨識 (吞噬、鎚子、十字、跳空、雙底頂、突破等 12+ 種) |
| 2026-05-11 | #28 | ✅ workmanager 背景排程 + isolate 內檢查警示並發通知 |
